    ...
    <div class="header-main">
        <div class="container">
            <div class="header-left">
                ...
                echo $logo;
                ?>
                <span class="text-below-logo" style="font-size: 19px;display: inline-block;width: 100%;text-align: center;color: #000;">Opening: 8am-9pm T2-CN ( Không nghỉ Lễ và Tết ).</span>
            </div>
