...
<div id="footer" class="footer-1<?php if ($porto_settings['footer-ribbon']) echo ' show-ribbon' ?>">
    ...
    <div class="footer-bottom">
        <div class="container">
                ...
                if ($porto_settings['footer-logo'] && $porto_settings['footer-logo']['url']) : ?>
                    <span class="logo">
                        <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?> - <?php bloginfo( 'description' ); ?>">
                            ...
                            <span style="margin-top: 12px;display: inline-block;width: 100%;">Chuyên Cung Cấp Sỉ và Lẻ Mắt kính Thời Trang Nam Nữ Các Loại.</span>
                        </a>
                    </span>
                <?php endif; ?>
                <?php
            ...
            <span style="text-decoration:underline">Địa chỉ</span>: 280/120/19 Bùi Hữu Nghĩa, Phường 2, Bình Thạnh, HCM (bên hông chợ Bà Chiểu).<br><span style="text-decoration:underline;">Điện thoại</span>: 0907 72 75 99.<br><span style="text-decoration:underline;">Thời gian làm việc</span>: 8am-9pm T2-CN (Không nghỉ Lễ và Tết).
            </div>
