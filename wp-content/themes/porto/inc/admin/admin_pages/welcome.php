...
<div class="wrap about-wrap porto-wrap">
    <h1><?php _e( 'N-U.L.L-24.N.E.T-Welcome to Porto!', 'porto' ); ?></h1>
    <div class="about-text"><?php echo esc_html__( 'N-U.L.L-24.N.E.T Porto is now installed and ready to use! Read below for additional information. We hope you enjoy it!', 'porto' ); ?></div>
